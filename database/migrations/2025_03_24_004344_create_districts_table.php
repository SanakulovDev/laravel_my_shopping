...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('districts', function (Blueprint $table) {
            $table->unsignedInteger('id', true);  // int(11) UNSIGNED with auto-increment
            
            // Change this line to match regions.id data type
            $table->unsignedInteger('region_id');  // Make it UNSIGNED to match
